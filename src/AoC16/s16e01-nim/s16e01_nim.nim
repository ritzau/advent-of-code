...
proc main() =
  ...
  echo "AoC 2016 Day 1: No Time for a Taxicab"
  echo "======================================"
  ...
  echo "Part 1: ", emoji1, " ", result1, " (expected: ", expectedPart1, ") [",
      formatFloat(duration1 * 1000, ffDecimal, 2), "ms]"
  ...
  echo "Part 2: ", emoji2, " ", result2, " (expected: ", expectedPart2, ") [",
      formatFloat(duration2 * 1000, ffDecimal, 2), "ms]"

  echo "Total: ", formatFloat((duration1 + duration2) * 1000, ffDecimal, 2),
      "ms"
