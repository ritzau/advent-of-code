    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        package = if builtins.pathExists ./generated.nix
          ...
          else haskellPackages.callCabal2nix "s21e01-haskell" ./. { };

        # Build package with tests enabled (for checks)
        packageWithTests = pkgs.haskell.lib.compose.doCheck (
          haskellPackages.callCabal2nix "s21e01-haskell" ./. { }
        );
      ...
      in
      {
        ...
        checks = {
          ...
          format-check = pkgs.stdenv.mkDerivation {
            name = "s21e01-haskell-format-check";
            src = ./.;
        ...
        apps = {
          ...
          default = {
            type = "app";
            program = "${package}/bin/s21e01-haskell";
            meta.description = "s21e01-haskell: Run all parts";
          };
          ...
          s21e01-haskell-part1 = {
            type = "app";
            program = "${package}/bin/s21e01-haskell-part1";
            meta.description = "s21e01-haskell: Run part 1";
          };

          s21e01-haskell-part2 = {
            type = "app";
            program = "${package}/bin/s21e01-haskell-part2";
            meta.description = "s21e01-haskell: Run part 2";
          };
        };
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            ...
            echo "  cabal run s21e01-haskell       - Run main executable"
            echo "  cabal run s21e01-haskell-part1 - Run part1"
