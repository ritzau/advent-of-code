...
export async function main() {
  ...
  logResult(
    "Async p1 sample",
    await part1Async(readLinesFromFile("AoC23E02-sample.txt")),
    8,
  );
  logResult(
    "Async p1 input",
    await part1Async(readLinesFromFile("AoC23E02-input.txt")),
    2632,
  );
  logResult(
    "Async p2 sample",
    await part2Async(readLinesFromFile("AoC23E02-sample.txt")),
    2286,
  );
  logResult(
    "Async p2 input",
    await part2Async(readLinesFromFile("AoC23E02-input.txt")),
    69629,
  );
}
